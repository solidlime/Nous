...
class ToolConfig(BaseModel):
    ...
    image_gen_comfyui_workflow_template: str = (
        "workflows/anima.json"  # path to API-format JSON workflow template (required; empty raises in ComfyUIProvider)
    )
    image_gen_comfyui_workflow_source: str = (
        "local"  # "local" | "comfyui"（ComfyUI 側 user/default/workflows から取得）
    )
    ...
    image_gen_full_body_prefix: str = "full body, standing, pov, "
