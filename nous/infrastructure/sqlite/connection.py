...
class SQLiteConnection:
    ...
    def initialize_schema(self) -> None:
        ...
        _comfyui_detail_migrations = [
            ...
            ("image_gen_max_width", "INTEGER", "1200"),
            ("image_gen_max_height", "INTEGER", "1200"),
            ("image_gen_self_portrait_prompt", "TEXT", "''"),
