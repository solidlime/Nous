  ...
  function applyChatConfig(cfg) {
    ...
    set(
      ...
      cfg.brain_enrich_interval_seconds ??
        _defaultOf("brain_enrich_interval_seconds") ??
        60,
    );
    ...
    set(
      ...
      cfg.brain_max_defer_seconds ??
        _defaultOf("brain_max_defer_seconds") ??
        3600,
    );
    ...
    set(
      ...
      cfg.brain_spontaneous_interval_hours ??
        _defaultOf("brain_spontaneous_interval_hours") ??
        1,
    );
    ...
    set(
      ...
      cfg.forgetting_trigger_threshold ??
        _defaultOf("forgetting_trigger_threshold") ??
        100,
    );
    set(
      "chat-forgetting-decay-interval-seconds",
      cfg.forgetting_decay_interval_seconds ??
        _defaultOf("forgetting_decay_interval_seconds") ??
        3600,
    );
