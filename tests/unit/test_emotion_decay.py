...
class TestComputeEmotionDecay:
    ...
    def test_decay_default_params(self) -> None:
        ...
        emotion, intensity = compute_emotion_decay(
            intensity=0.8, elapsed_hours=24.0, emotion="joy"
        )
    ...
    def test_decay_with_custom_half_life(self) -> None:
        ...
        _, intensity_24 = compute_emotion_decay(
            intensity=0.8, elapsed_hours=24.0, emotion="joy"
        )
        _, intensity_12 = compute_emotion_decay(
            intensity=0.8, elapsed_hours=24.0, emotion="joy", half_life_hours=12.0
        )
        assert intensity_12 < intensity_24, (
            f"Shorter half_life should decay faster: {intensity_12} < {intensity_24}"
        )
    ...
    def test_decay_with_custom_threshold(self) -> None:
        ...
        emotion, intensity = compute_emotion_decay(
            intensity=0.8, elapsed_hours=1.0, emotion="joy", threshold=0.5
        )
    ...
    def test_decay_with_neutral_threshold(self) -> None:
        ...
        emotion, intensity = compute_emotion_decay(
            intensity=0.05, elapsed_hours=48.0, emotion="joy",
            half_life_hours=6.0, neutral_threshold=0.1,
        )
    ...
    def test_zero_elapsed_returns_emotion_zero(self) -> None:
        ...
        emotion, intensity = compute_emotion_decay(
            intensity=0.8, elapsed_hours=0.0, emotion="joy"
        )
        assert emotion == "joy"
        assert intensity == 0.0

        emotion, intensity = compute_emotion_decay(
            intensity=0.8, elapsed_hours=-1.0, emotion="joy"
        )
        assert emotion == "joy"
        assert intensity == 0.0
    ...
    def test_zero_intensity_returns_emotion_zero(self) -> None:
        ...
        emotion, intensity = compute_emotion_decay(
            intensity=0.0, elapsed_hours=24.0, emotion="joy"
        )
        assert emotion == "joy"
        assert intensity == 0.0
    ...
    def test_emotion_labels_preserved_through_decay(self, emotion: str, label: str) -> None:
        ...
        e, i = compute_emotion_decay(
            intensity=0.6, elapsed_hours=4.0, emotion=emotion,
        )
